...
template <class charT, class traits = char_traits<charT>>
class basic_string : public std::basic_string<charT, traits, polymorphic_allocator<charT>> {
  ...
  public:
    ...
    basic_string(basic_string &&str) noexcept
        : Base(std::move(str)) {}
    basic_string(const Base &str, size_type pos, size_type n = Base::npos, const Allocator &a = Allocator())
        : Base(str, pos, n, a) {}
    ...
    basic_string(
        ...
        typename enable_if<is_constructible<Base, InputIterator, InputIterator>::value, Dummy>::type = {})
        : Base(begin, end, a) {}
